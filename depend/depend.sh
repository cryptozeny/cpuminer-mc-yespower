...
wget http://curl.haxx.se/gknw.net/rm/7.38.0/dist-w64/curl-7.38.0-devel-mingw64.zip
...
wget http://curl.haxx.se/gknw.net/rm/7.38.0/dist-w32/curl-7.38.0-devel-mingw32.zip
